      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-6 font-mono">
            <span className="text-green-400">{">"}</span> TERMS OF ENGAGEMENT
          </h1>
        ...
        <div className="space-y-8">
          ...
          <Card className="bg-black/40 border-green-400/20">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="font-mono text-green-400 mb-2">Permitted Use</h3>
              ...
              <div>
                <h3 className="font-mono text-green-400 mb-2">Prohibited Use</h3>
                <ul className="list-disc list-inside text-gray-300 space-y-1">
          ...
          <Card className="bg-black/40 border-green-400/20">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="font-mono text-green-400 mb-2">Website Content</h3>
              ...
              <div>
                <h3 className="font-mono text-green-400 mb-2">Project Showcases</h3>
                <p className="text-gray-300">
              ...
              <div>
                <h3 className="font-mono text-green-400 mb-2">Open Source</h3>
                <p className="text-gray-300">
          ...
          <Card className="bg-black/40 border-green-400/20">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="font-mono text-green-400 mb-2">Professional Information</h3>
                <p className="text-gray-300">
              ...
              <div>
                <h3 className="font-mono text-green-400 mb-2">External Links</h3>
                <p className="text-gray-300">
              ...
              <div>
                <h3 className="font-mono text-green-400 mb-2">Technical Performance</h3>
                <p className="text-gray-300">
          ...
          <Card className="bg-black/40 border-green-400/20">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="font-mono text-green-400 mb-2">Consultation Inquiries</h3>
                <p className="text-gray-300">
              ...
              <div>
                <h3 className="font-mono text-green-400 mb-2">Confidentiality</h3>
                <p className="text-gray-300">
          ...
          <Card className="bg-black/40 border-green-400/20">
            <CardHeader>
              <CardTitle className="font-mono text-green-400">GOVERNING LAW</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-300 leading-relaxed">
          ...
          <Card className="bg-black/40 border-green-400/20">
            <CardHeader>
              <CardTitle className="font-mono text-green-400">CONTACT INFORMATION</CardTitle>
            </CardHeader>
            <CardContent>
