...
export default function HistoryPage() {
  const [history, setHistory] = useState<{ experience: any[]; certifications: any[] }>({ experience: [], certifications: [] })
    ...
    <div className="relative min-h-screen">
      ...
      <section className="relative z-10 pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <span className="text-green-500">{">"}</span> MISSION HISTORY
          </motion.h2>
          ...
          >
            <span className="text-green-500">{">"}</span> CLEARANCES
          </motion.h2>
